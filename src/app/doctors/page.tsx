...
interface PageProps {
  searchParams: { specialization?: string; city?: string; page?: string }
}
...
export default async function DoctorsPage({ searchParams }: PageProps) {
  ...
  if (searchParams.specialization) where.specialization = { contains: searchParams.specialization, mode: 'insensitive' }
    ...
    <div className="min-h-screen bg-slate-950">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <form className="flex gap-3 mb-8" method="GET">
          <input name="specialization" defaultValue={searchParams.specialization}
          ...
          <input name="city" defaultValue={searchParams.city}
